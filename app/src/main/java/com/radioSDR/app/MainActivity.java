...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkPermissions() {
        ...
        String[] permissions = android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.TIRAMISU ? 
            REQUIRED_PERMISSIONS_API33 : REQUIRED_PERMISSIONS;
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_REQUEST_CODE) {
            ...
            if (deniedPermissions.isEmpty()) {
                ...
                String message = "Permissões negadas: ";
                ...
                // Mostrar informações sobre quais permissões ainda são necessárias
                ...
                if (deniedPermissions.contains(Manifest.permission.WRITE_EXTERNAL_STORAGE) || 
                    ...
                    Log.w(TAG, "ATENÇÃO: Permissões de armazenamento negadas - gravação pode não funcionar");
                }
            }
        }
    }
